<?php
      ...
      if($result){
            while($row = mysqli_fetch_assoc($result)){
                  ...
                  $country_id = mysqli_fetch_assoc($final)['id'];
                  $dateRep = $row['dateRep'];
                  $day = $row['day'];
                  $month = $row['month'];
                  $year = $row['year'];
                  ...
                  $query_insertar_en_entries = "INSERT INTO entries (country_id, dateRep, day, month, year, cases, deaths, Acumulative_number_for_14_days_of_COVID) 
                  VALUES (".$country_id.",'".$dateRep."', ".$day.", ".$month.", ".$year.", ".$cases.", ".$deaths.", ".$Acumulative_number_for_14_days_of_COVID.");";
                  print_r($query1);
